...
const testSuite = [
    ...
    new Test(2, "[sound] Preload a server chuck file, runFile, 440Hz 1 second", async () => {
        let aChuck = await Chuck.init([{serverFilename: "./testFiles/test2.ck", virtualFilename: "test2.ck"}], undefined, undefined, "../src/");
    ...
    new Test(3, "[sound] Dynamic load in a chuck file from URL, 880Hz 1 second", async () => {
        let aChuck = await Chuck.init([], undefined, undefined, "../src/");
        let outputBox = document.getElementById("output-" + 3);
        aChuck.chuckPrint = (output) => {
            outputBox.innerText = output;
        }
    ...
    new Test(4, "[sound] Dynamic load in a kick wav file from URL", async () => {
        let aChuck = await Chuck.init([], undefined, undefined, "../src/");
        let outputBox = document.getElementById("output-" + 4);
        aChuck.chuckPrint = (output) => {
            outputBox.innerText = output;
        }
    ...
    new Test(5, "Sync test set/get int and float, webchuck and js", async () => {
        let outputBox = document.getElementById("output-" + 5);
        devChuck.runCode(`
            1 => global int GLOBAL_INT;
            1.0 => global float GLOBAL_FLOAT;
        `);
        await new Promise(resolve => setTimeout(resolve, 100));
        let test1 = await devChuck.getInt("GLOBAL_INT") == 1 && await devChuck.getFloat("GLOBAL_FLOAT") == 1.0;
        outputBox.innerHTML += "Get OK " + test1 + "<br>";
        devChuck.setInt("GLOBAL_INT", 2);
        devChuck.setFloat("GLOBAL_FLOAT", 2.0);
        await new Promise(resolve => setTimeout(resolve, 300));
        let test2 = await devChuck.getInt("GLOBAL_INT") == 2 && await devChuck.getFloat("GLOBAL_FLOAT") == 2.0;
    ...
    new Test(6, "Test shred management, add, remove, replace", async () => {
        let aChuck = await Chuck.init([], undefined, undefined, "../src/");
        let outputBox = document.getElementById("output-" + 6);
        aChuck.chuckPrint = (output) => {
    ...
    new Test(7, "Test RunFileWithArgs", async () => {
        let aChuck = await Chuck.init([], undefined, undefined, "../src/");
        let outputBox = document.getElementById("output-" + 7);
    ...
    new Test(8, "Test isShredActive", async () => {
        let aChuck = await Chuck.init([], undefined, undefined, "../src/");
        let outputBox = document.getElementById("output-" + 8);
    ...
    new Test(9, "Machine.add/replace/remove/clear", async () => {
        ...
        let outputBox = document.getElementById("output-" + 9);
    ...
    new Test(10, "Chuck get Promise<type> returns", async () => {
        let aChuck = await Chuck.init([], undefined, undefined, "../src/");
        let outputBox = document.getElementById("output-" + 10);
        ...
        let outputBox = document.getElementById("output-" + 11);
    ...
    new Test(12, "HID - mouse", async () => {
        let aChuck = await Chuck.init([], undefined, undefined, "../src/");
        let outputBox = document.getElementById("output-" + 12);
        print = (output) => {
            outputBox.innerHTML = output + "<br>";
        }
        aChuck.chuckPrint = print;
    ...
    new Test(13, "HID - keyboard", async () => {
        let aChuck = await Chuck.init([], undefined, undefined, "../src/");
        let outputBox = document.getElementById("output-" + 13);
        print = (output) => {
            outputBox.innerHTML = output + "<br>";
        }
        aChuck.chuckPrint = print;
    ...
    new Test(99, "Chuck VM operations and parameters", async () => {
        let aChuck = await Chuck.init([], undefined, undefined, "../src/");
        let outputBox = document.getElementById("output-" + 99);
